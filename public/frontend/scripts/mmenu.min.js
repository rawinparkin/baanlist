    ...
    function (e, t, n) {
                ...
                return (
                    (e.prototype.openPanel = function (e, t) {
                        ...
                        if (
                            ...
                            if (
                                ...
                                e.parentElement.matches(
                                    ".mm-listitem_vertical"
                                ))
                            ) {
                                y(e, ".mm-listitem_vertical").forEach(function (
                                    e
                                ) {
                    ...
                    (e.prototype.setSelected = function (e) {
                        this.trigger("setSelected:before", [e]),
                            g(this.node.menu, ".mm-listitem_selected").forEach(
                                function (e) {
                                    e.classList.remove("mm-listitem_selected");
                                }
                            ),
                    ...
                    (e.prototype._initExtensions = function () {
                        ...
                        this.trigger("initExtensions:before"),
                            ...
                            Object.keys(this.opts.extensions).forEach(function (
                                t
                            ) {
                    ...
                    (e.prototype.initPanel = function (e) {
                        ...
                        if (
                            e.matches(n) &&
                            (e.matches(".mm-panel") || (e = this._initPanel(e)),
                            e)
                        ) {
                            var i = [];
                            i.push.apply(
                                i,
                                _(e, "." + this.conf.classNames.panel)
                            ),
                    ...
                    (e.prototype._initOpened = function () {
                        ...
                        var e = this.node.pnls.querySelectorAll(
                                ".mm-listitem_selected"
                            ),
                            t = null;
        ...
        (S.prototype.open = function () {
            ...
            (S.prototype._openSetup = function () {
                ...
                this.closeAllOthers(),
                    (S.node.page.mmStyle =
                        S.node.page.getAttribute("style") || ""),
                    (function (e, t, n) {
                        var i = t.split(".");
                        (e[(t = "mmEvent" + T(i[0]) + T(i[1]))] || []).forEach(
                            function (e) {
                                e(n || {});
                            }
                        );
            ...
            j = function () {
                ...
                if (t.blockUI) {
                    ...
                    var s = function (t) {
                        t.preventDefault(),
                            t.stopPropagation(),
                            e.node.wrpr.matches(".mm-wrapper_modal") ||
                                e.close();
                    };
                ...
                return (
                    ...
                    (e.prototype.stop = function (e) {
                        if (this.state == te) {
                            ...
                            if (
                                ...
                                Math.abs(this.movement[this.axis]) >
                                    this.treshold.swipe)
                            ) {
                        ...
                        switch (this.state) {
                            ...
                            case te:
                                ...
                                (this.movement = {
                                    ...
                                    (this.axis =
                                        Math.abs(this.distance.x) >
                                        Math.abs(this.distance.y)
                                            ? "x"
                                            : "y");
                                ...
                                this.state == ee &&
                                    Math.abs(this.distance[this.axis]) >
                                        this.treshold.start &&
                                    (this._dispatchEvents("drag*Start", i),
                                    (this.state = te)),
                                    this.state == te &&
                                        this._dispatchEvents("drag*Move", i);
                        }
                    }),
                    ...
                    (e.prototype._dispatchEvents = function (e, t) {
                        ...
                        var i = new CustomEvent(
                            e.replace("*", this.axis.toUpperCase()),
                            { detail: t }
                        );
            ...
            if (void 0 !== t) {
                ...
                t.length &&
                    ...
                    this.bind("initMenu:after", function () {
                        for (var t in n)
                            e.node.menu["bottom" == t ? "append" : "prepend"](
                                n[t]
                            );
                    }));
            }
        ...
        (S.options.navbars = be),
            ...
            (_e.navbarContents = {
                    ...
                    e.append(n),
                        this.bind("initNavbar:after", function (e) {
                            if (!e.querySelector(".mm-navbar__breadcrumbs")) {
                                ...
                                t.conf.navbars.breadcrumbs.removeFirst &&
                                    n.shift(),
                                    (i.innerHTML = n.join(
                                        '<span class="mm-separator">' +
                                            t.conf.navbars.breadcrumbs
                                                .separator +
                                            "</span>"
                                    )),
                ...
                searchfield: function (e) {
                    "object" != o(this.opts.searchfield) &&
        ...
        var Se = function () {
                ...
                (t = b("div.mm-panel.mm-panel_search.mm-hidden")),
                    ...
                    e.panel.title &&
                        t.setAttribute("data-mm-title", e.panel.title);
                var n = b("ul");
                switch (
                    (t.append(n),
            ...
            Me = function (e) {
                ...
                (i(a, n.form), n.form && n.submit && !n.clear) &&
                    ...
                    o.append(s));
                t.cancel &&
                    ((s = b("a.mm-searchfield__cancel")).setAttribute(
                        "href",
                        "#"
                    ),
                ...
                o.forEach(function (e) {
                    ...
                    l.forEach(function (e) {
                        g(e, ".mm-panel__noresultsmsg").forEach(function (e) {
                            return e.classList[p ? "add" : "remove"](
                                "mm-hidden"
                            );
                        });
                    }),
        ...
        (S.addons = {
                    ...
                    this._api.push("open", "close", "setPage"),
                        ...
                        this.bind("initMenu:before", function () {
                            n.clone &&
                                ...
                                e.node.menu.id &&
                                    (e.node.menu.id = "mm-" + e.node.menu.id),
                    ...
                    t.text &&
                        ...
                        this.bind("initNavbar:after", function (t) {
                            ...
                            if (i) {
                                ...
                                s &&
                                    (s.innerHTML = S.sr_text(
                                        e.i18n(n.text.closeSubmenu)
                                    ));
                            }
                        }),
                        ...
                        this.node.menu.addEventListener("scroll", o, {
                            ...
                            window.addEventListener(
                                ...
                                function (t) {
                                    ...
                                    n &&
                                        ((n.scrollTop = 0),
                                        (n.style["-webkit-overflow-scrolling"] =
                                            "auto"),
                                        (n.style["-webkit-overflow-scrolling"] =
                                            "touch"));
                                }
                            ...
                            ((n = function (e) {
                                return (
                                    e.parentElement.matches(
                                        ...
                                        (e = y(e, ".mm-panel").filter(function (
                                            e
                                        ) {
                                            return !e.parentElement.matches(
                                                ".mm-listitem_vertical"
                            ...
                            function () {
                                if (!e.opts.offCanvas || e.vars.opened) {
                                    var i,
                                        ...
                                        a = 0,
                                        o =
                                            e.node.menu.offsetHeight -
                                            e.node.pnls.offsetHeight;
                                    e.node.menu.classList.add(
                    ...
                    s.push.apply(s, i),
                        this.bind("openPanel:before", function (t) {
                            ...
                            if (
                                ...
                                if (
                                    i.length &&
                                    (i = i.split("mm-panel_columns-")[1])
                                )
                                    for (
                                        var a =
                                            parseInt(i.split(" ")[0], 10) + 1;
                                        a > 0;
                    ...
                    this.bind("initListview:after", function (t) {
                        _(t).forEach(function (t) {
                            E(t, e.conf.classNames.divider, "mm-divider"),
                                t.matches(".mm-divider") &&
                                    t.classList.remove("mm-listitem");
                        });
                    }),
                    t.add &&
                        this.bind("initListview:after", function (e) {
                ...
                if (this.opts.offCanvas) {
                    ...
                    if (t.drop) {
                        ...
                        this.bind("initMenu:after", function () {
                            ...
                            this.bind("open:start", function () {
                                (e.node.menu.mmStyle =
                                    e.node.menu.getAttribute("style")),
                                    e.node.wrpr.classList.add(
                                        "mm-wrapper_dropdown"
                                    );
                            }),
                            this.bind("close:finish", function () {
                                e.node.menu.setAttribute(
                                    "style",
                                    e.node.menu.mmStyle
                                ),
                    ...
                    (["top", "bottom"].forEach(function (t, i) {
                        ...
                        for (
                            ...
                            "string" == typeof s[r]
                                ...
                                : a.append(s[r]);
                        a.children.length &&
                            (e || (e = b("div.mm-iconbar")), e.append(a));
                    }),
                    e)
                ) {
                    this.bind("initMenu:after", function () {
                        ...
                        if (
                            ...
                            if (n)
                                ...
                                a.forEach(function (e) {
                                    ...
                                    (a = a.slice(-t.visible)).forEach(function (
                                        e,
                                        t
                                    ) {
                                        e.classList.add(
                                            "mm-panel_iconpanel-" + t
                                        );
                                    });
                            }
                    }),
                    ...
                    if (
                        ...
                        this.bind("initMenu:after", function () {
                            ...
                            this.bind("initBlocker:after", function () {
                                S.node.blck.append(s),
                                    _(S.node.blck, "a")[0].classList.add(
                                        "mm-tabstart"
                                    );
                            });
                        var o =
                                "input, select, textarea, button, label, a[href]",
                            r = function (n) {
                        ...
                        this.bind("open:finish", r),
                            ...
                            this.bind("initOpened:after:sr-aria", function () {
                                [e.node.menu, S.node.blck].forEach(function (
                                    e
                                ) {
                                    _(e, ".mm-tabstart, .mm-tabend").forEach(
                                        function (e) {
                                            S.sr_aria(e, "hidden", !0),
            ...
            lazySubmenus: function () {
                ...
                (this.opts.lazySubmenus = a(t, S.options.lazySubmenus)),
                    t.load &&
                        ...
                        this.bind("openPanel:before", function (t) {
                            var n = g(t, ".mm-panel_lazysubmenu").filter(
                                function (e) {
                                    return !e.matches(
                            ...
                            if (r[s].offsetTop < n + i.updateOffset) {
                                if (c !== s) {
                                    ...
                                    (a = a.filter(function (e) {
                                        ...
                                        e.setSelected(a[0].parentElement);
                                }
                                break;
                            }
                    });
                    ...
                    t.add &&
                        this.bind("initPanels:after", function () {
                            ...
                            e.bind("openPanel:start", function (t) {
                                var n = g(t, ".mm-divider").filter(function (
                                    e
                                ) {
                                    return !e.matches(".mm-hidden");
                                }).length;
            ...
            sidebar: function () {
                ...
                if (this.opts.offCanvas) {
                    ...
                    if (
                        ((this.opts.sidebar = a(t, S.options.sidebar)),
                        t.collapsed.use)
                    ) {
                        this.bind("initMenu:after", function () {
                            if (
