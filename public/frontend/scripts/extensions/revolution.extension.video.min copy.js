...
!(function (e) {
    ...
    jQuery.extend(!0, a, {
        ...
        playVideo: function (e, o) {
            switch (
                (clearTimeout(e.data("videoplaywait")), e.data("videotype"))
            ) {
                case "youtube":
        ...
        checkVideoApis: function (e, t, a) {
            var i = "https:" === location.protocol ? "https" : "https";
            if (
                ((void 0 != e.data("ytid") ||
                    ...
                    jQuery("head")
                        ...
                        .each(function () {
                            jQuery(this).attr("src") ==
                                i + "://a.vimeocdn.com/js/froogaloop2.min.js" &&
                                (r = !1);
                        }),
            ...
            switch ((e.data("videotype", T), k)) {
                case "html5":
                    ...
                    void 0 != f &&
                        ...
                        (x =
                            x + '<source src="' + f + '" type="video/webm" />'),
                        void 0 != g &&
                            (x =
                                x +
                                '<source src="' +
                    ...
                    ("true" === m || m === !0) &&
                        ...
                        e.append(x),
                        ((i && 1 == e.data("disablevideoonmobile")) ||
                            a.isIE(8)) &&
                            e.find("video").remove(),
                ...
                switch (e.data("videotype")) {
                            ...
                            events: {
                                onStateChange: function (e) {
                                    ...
                                    if (e.data == YT.PlayerState.PLAYING)
                                        ...
                                        (0 == e.data || 2 == e.data) &&
                                            "on" ==
                                                p.data("showcoveronpause") &&
                                            p.find(".tp-videoposter").length >
                                                0 &&
                                            (punchgs.TweenLite.to(
                                                p.find(".tp-videoposter"),
                                                0.3,
                                            ...
                                            -1 != e.data &&
                                                ...
                                                (void 0 ==
                                                    d.currentLayerVideoIsPlaying ||
                                                    d.currentLayerVideoIsPlaying.attr(
                                                        "id"
                                                    ) == p.attr("id")) &&
                                                    a.unToggleState(
                                                        p.data("videotoggledby")
                    ...
                    case "vimeo":
                        for (
                            ...
                            m[decodeURIComponent(f[1])] = decodeURIComponent(
                                f[2]
                            );
                        y =
                            void 0 != m.player_id
                ...
                d(v, "pause", function () {
                    ...
                    void 0 != t && (t.innerHTML = "Play"),
                        (void 0 == r.currentLayerVideoIsPlaying ||
                            r.currentLayerVideoIsPlaying.attr("id") ==
                                e.attr("id")) &&
