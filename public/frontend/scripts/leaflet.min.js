...
!(function (t, i) {
    ...
    if ("onselectstart" in document)
        ...
        ($t = function () {
            ...
            (Qt = function () {
                Li &&
                    ((document.documentElement.style[Li] = ti), (ti = void 0));
            });
    }
    function bi() {
    ...
    function Ni(t) {
        return (
            Ei(t, "mousedown touchstart dblclick", Oi), Ai(t, "click", qi), this
        );
    }
    function Di(t) {
        return (
        ...
        Ji = k.extend({
            ...
            initialize: function (t, i) {
                (i = p(this, i)),
                    ...
                    this.callInitHooks(),
                    (this._zoomAnimated =
                        oi && yt && !zt && this.options.zoomAnimation),
                    this._zoomAnimated &&
    ...
    var te = Qi.extend({
            ...
            addTo: function (t) {
                return (
                    Qi.prototype.addTo.call(this, t),
            ...
            collapse: function () {
                return (
                    mi(this._container, "leaflet-control-layers-expanded"), this
                );
            },
            _initLayout: function () {
                ...
                if (
                    ...
                    !di(this._element, "leaflet-zoom-anim") &&
                        !(
                            ...
                            ((le._dragging = this)._preventOutline &&
                                zi(this._element),
                            bi(),
                            $t(),
                            this._moving)
    ...
    var we,
        ...
        ze = h({}, U, {
            ...
            projection: be,
            transformation:
                ((we = 0.5 / (Math.PI * be.R)), K(we, 0.5, -we, 0.5)),
        }),
        Me = h({}, U, {
            code: "EPSG:4326",
            projection: Le,
    ...
    var Oe = Se.extend({
        ...
        Re = Oe.extend({
            ...
            setStyle: function (t) {
                ...
                return (
                    Oe.prototype.setStyle.call(this, t), this.setRadius(i), this
                );
            },
            _project: function () {
    ...
    function He(t, i) {
        ...
        switch (r.type) {
            ...
            case "MultiLineString":
                return (
                    (n = Ue(a, "LineString" === r.type ? 0 : 1, l)),
                    new De(n, i)
                );
            case "Polygon":
            case "MultiPolygon":
                return (
                    (n = Ue(a, "Polygon" === r.type ? 1 : 2, l)), new je(n, i)
                );
        ...
        nn = en.extend({
            ...
            onAdd: function (t) {
                en.prototype.onAdd.call(this, t),
                    ...
                    this._source &&
                        ...
                        this._source instanceof Oe ||
                            this._source.on("preclick", Oi));
            },
            onRemove: function (t) {
            ...
            _adjustPan: function () {
                if (this.options.autoPan) {
                    ...
                    var t = this._map,
                        i =
                            parseInt(ai(this._container, "marginBottom"), 10) ||
                            0,
    ...
    var rn = Se.extend({
        ...
        bringToFront: function () {
            return (
                this._map &&
                    (ci(this._container), this._setAutoZIndex(Math.max)),
                this
            );
        },
        bringToBack: function () {
            return (
                this._map &&
                    (_i(this._container), this._setAutoZIndex(Math.min)),
                this
            );
        },
        getContainer: function () {
    ...
    var ln = Se.extend({
            ...
            onAdd: function () {
                this._container ||
                    (this._initContainer(),
                    this._zoomAnimated &&
                        pi(this._container, "leaflet-zoom-animated")),
                    this.getPane().appendChild(this._container),
                    this._update(),
    ...
    var yn = oe.extend({
        ...
        _finish: function () {
            this._moved &&
                (ui(this._box), mi(this._container, "leaflet-crosshair")),
                Qt(),
                Ti(),
                Bi(
                    document,
