    ...
    $(document).ready(function () {
        ...
        $("#listeo-listings-container").on(
            ...
            function (event, page, append, loading_previous) {
                ...
                var tax_classifieds_category = results.data(
                ...
                if (!has_event_category_search) {
                    if (tax_event_category) {
                        data.push({
                            name: "tax-event_category",
                            value: tax_event_category,
                        });
                    }
                }
        ...
        if ($("#listeo_core-search-form:not(.main-search-form)").length) {
            document.getElementById("listeo_core-search-form").onkeypress =
                function (e) {
        ...
        $(document).on(
            "click",
            "span.panel-disable,.slider-disable",
            function (e) {
                var results = $("#listeo-listings-container");
        ...
        $("div.pagination-container.ajax-search").on(
            "click",
            "a",
            function (e) {
                e.preventDefault();
        ...
        $(".tax-listing_category #tax-listing_category").on(
            "change",
            function (e) {
