    ...
    e.fn.extend({
                ...
                if (
                    ...
                    if (l && l.li.length > 0 && (a > 0 || a <= l.li.length)) {
                        ...
                        (l.slideamount = l.slideamount - 1),
                            ...
                            l.carousel &&
                                l.carousel.slides &&
                                (l.carousel.slides = n(l.carousel.slides, a)),
        ...
        revkill: function (a) {
            ...
            if (
                ...
                o != t &&
                    o.length > 0 &&
                    e("body").find("#" + o.attr("id")).length > 0)
            ) {
                o.data("conthover", 1),
                ...
                e(window).off(l),
                    o.find("*").each(function () {
                        ...
                        i.unbind(
                            ...
                            i.data("timeline_out") != t &&
                                i.data("timeline_out").kill(),
                            i.data("timeline") != t &&
    ...
    var a = i.is_mobile(),
        ...
        s = function (a, n) {
            ...
            return (
                ...
                (o.layeranim = !1),
                (o.migration = !1),
                n.data("version") && n.data("version").toString().match(/5./gi)
                    ? (n.find("img").each(function () {
                      ...
                      n.find("li").each(function () {
                          e(this).data("link") &&
                              e(this).data("link") != t &&
                              ((o.layeranim = !0), (o.actions = !0));
                      }),
                      !o.videos &&
                          (n.find(".rs-background-video-layer").length > 0 ||
                              n.find(".tp-videolayer").length > 0 ||
                              n.find("iframe").length > 0 ||
                              n.find("video").length > 0) &&
                          (o.videos = !0),
                      "carousel" == a.sliderType && (o.carousel = !0),
                      ("off" !== a.parallax.type ||
                          a.viewPort.enable ||
                    ...
                    : ((o.kenburns = !0),
                      ...
                      (o.migration = !0)),
                "hero" == a.sliderType &&
                    ((o.carousel = !1), (o.navigation = !1)),
                window.location.href.match(/file:/gi) &&
                    ((o.filesystem = !0), (a.filesystem = !0)),
                o.videos &&
                    "undefined" == typeof i.isVideoPlaying &&
                    r("revolution.extension.video", a),
                o.carousel &&
                    "undefined" == typeof i.prepareCarousel &&
                    r("revolution.extension.carousel", a),
                o.carousel ||
                    "undefined" != typeof i.animateSlide ||
                    r("revolution.extension.slideanims", a),
                o.actions &&
                    "undefined" == typeof i.checkActions &&
                    r("revolution.extension.actions", a),
                o.layeranim &&
                    "undefined" == typeof i.handleStaticLayers &&
                    r("revolution.extension.layeranimation", a),
                o.kenburns &&
                    "undefined" == typeof i.stopKenBurn &&
                    r("revolution.extension.kenburn", a),
                o.navigation &&
                    "undefined" == typeof i.createNavigation &&
                    r("revolution.extension.navigation", a),
                o.migration &&
                    "undefined" == typeof i.migration &&
                    r("revolution.extension.migration", a),
                o.parallax &&
                    "undefined" == typeof i.checkForParallax &&
                    r("revolution.extension.parallax", a),
                o
            );
        },
        l = function (e, t) {
            ...
            ("undefined" != typeof punchgs &&
                (!t.kenburns ||
                    (t.kenburns && "undefined" != typeof i.stopKenBurn)) &&
                (!t.navigation ||
                    (t.navigation &&
                        "undefined" != typeof i.createNavigation)) &&
                (!t.carousel ||
                ...
                (!t.videos ||
                    (t.videos && "undefined" != typeof i.resetVideo)) &&
                (!t.actions ||
                    (t.actions && "undefined" != typeof i.checkActions)) &&
                (!t.layeranim ||
                    (t.layeranim &&
                        "undefined" != typeof i.handleStaticLayers)) &&
                (!t.migration ||
                    (t.migration && "undefined" != typeof i.migration)) &&
                (!t.parallax ||
                    (t.parallax && "undefined" != typeof i.checkForParallax)) &&
                (t.carousel ||
                    (!t.carousel && "undefined" != typeof i.animateSlide)))
        ...
        h = function (n, o) {
            ...
            if (
                ...
                (o.gridwidth = f(o.gridwidth, o.rle)),
                (o.gridheight = f(o.gridheight, o.rle)),
                "on" == o.simplifyAll &&
                    ...
                    o.li.each(function () {
                        ...
                        t.data("transition", "fade"),
                            ...
                            t.data("slotamount", 1);
                        var i =
                            t.find(".rev-slidebg") || t.find(">img").first();
                        i.data("kenburns", "off");
                    })),
                ...
                (o.autoHeight =
                    "fullscreen" == o.sliderLayout ? "on" : o.autoHeight),
                "fullwidth" == o.sliderLayout &&
                    "off" == o.autoHeight &&
                    n.css({ maxHeight: o.gridheight[o.curWinRange] + "px" }),
                "auto" != o.sliderLayout &&
                    0 ==
                        n.closest(".forcefullwidth_wrapper_tp_banner").length &&
                    ("fullscreen" !== o.sliderLayout ||
                        "on" != o.fullScreenAutoWidth))
            ) {
                var p = n.parent(),
            ...
            if (
                    ...
                    n
                        ...
                        .each(function (n) {
                            var r = e(this),
                                ...
                                l = r.data("autoplay");
                            r.hasClass("tp-static-layer") &&
                                i.handleStaticLayers &&
                                i.handleStaticLayers(r, o);
                            var d =
                ...
                (o.inviewport = !1),
                    O != t &&
                        O.enable &&
                        (e.isNumeric(O.visible_area) ||
                            (-1 !== O.visible_area.indexOf("%") &&
                                (O.visible_area =
                                    parseInt(O.visible_area) / 100)),
                          ...
                          void (
                              (n.outerWidth(!0) != o.width ||
                                  ...
                                  ("fullscreen" == o.sliderLayout &&
                                      e(window).height() !=
                                          o.lastwindowheight)) &&
                              ((o.lastwindowheight = e(window).height()),
                              b(n, o))
                          ));
                }),
                    m(n, o),
                        ...
                        n.layersonhover &&
                            e.each(n.layersonhover, function (e, t) {
                                t.data("animdirection", "out"),
                                    ...
                                    i.endMoveCaption &&
                                        i.endMoveCaption(t, null, null, n);
                            });
                    }),
            ...
            if (
                ...
                "fullscreen" == t.sliderLayout && "on" == t.fullScreenAutoWidth
                    ...
                    : punchgs.TweenLite.set(t.ul, {
                          left: a,
                          width:
                              t.c.width() - i.getHorizontalOffset(t.c, "both"),
                      });
            else {
                var n = Math.ceil(
                    t.c.closest(".forcefullwidth_wrapper_tp_banner").offset()
                        .left - a
                );
                punchgs.TweenLite.set(t.c.parent(), {
                    left: 0 - n + "px",
                    width:
                        e(window).width() - i.getHorizontalOffset(t.c, "both"),
                });
            }
            t.slayers &&
        ...
        m = function (a, n, o) {
            ...
            e(window).width() < n.hideSliderAtLimit
                ? (a.trigger("stoptimer"),
                  "none" != r.css("display") &&
                      r.data("olddisplay", r.css("display")),
                  r.css({ display: "none" }))
                : a.is(":hidden") &&
                  o &&
                  (r.data("olddisplay") != t &&
        ...
        b = function (a, n) {
            if (
                ...
                x(a, n, a, 2),
                    ...
                    i.animateTheCaptions &&
                        i.animateTheCaptions(r.closest("li"), n, !0),
                    i.manageNavigation && i.manageNavigation(n);
            }
        },
        y = function (e) {
            ...
            n.parent().css({ overflow: "visible" }),
                o.li.find(">img").each(function (i) {
                    ...
                    r.addClass("defaultvid").css({ zIndex: 30 }),
                        ...
                        "on" == o.fallbacks.panZoomDisableOnMobile &&
                            a &&
                            (n.data("kenburns", "off"),
                            n.data("bgfit", "cover")),
                        n.wrap(
                    ...
                    n.closest(".slotholder").data(s),
                        r.length > 0 &&
                            s.bgparallax != t &&
                            r.data("bgparallax", s.bgparallax),
                    ...
                    n.replaceWith(c),
                        ...
                        n.data(s),
                        n.attr("src", l),
                        ("standard" === o.sliderType ||
                            "undefined" === o.sliderType) &&
                            n.css({ opacity: 0 });
                });
        },
        x = function (t, i, a, n) {
                ...
                i.loadqueue &&
                    e.each(i.loadqueue, function (e, i) {
                        ...
                        (o = o.substring(0, o.length - 1) + n),
                            (r += n),
                            (_(r) === _(decodeURIComponent(t.src)) ||
                                _(o) === _(decodeURIComponent(t.src)) ||
                                _(d) === _(decodeURIComponent(t.src)) ||
                                _(l) === _(decodeURIComponent(t.src)) ||
                                _(s) === _(decodeURIComponent(t.src)) ||
                                _(i.src) === _(decodeURIComponent(t.src)) ||
                                _(i.src).replace(/^.*\/\/[^\/]+/, "") ===
                                    _(decodeURIComponent(t.src)).replace(
                                        /^.*\/\/[^\/]+/,
                                        ""
                                    ) ||
                                ("file://" === window.location.origin &&
                                    _(t.src).match(new RegExp(n)))) &&
                                ((i.progress = a),
                                (i.width = t.width),
                                (i.height = t.height));
                    }),
        ...
        H = function (t, a) {
            ...
            return o.index() === n.index()
                ...
                : (o
                      .removeClass("next-revslide")
                      .addClass("processing-revslide"),
                  o.data(
                      "slide_on_focus_amount",
                      o.data("slide_on_focus_amount") + 1 || 1
                  ),
                  "on" == a.stopLoop &&
        ...
        O = function (e, a, n) {
            ...
            (e.sdir = c > u ? 1 : 0),
                ...
                r.hasClass("rs-pause-timer-once") ||
                r.hasClass("rs-pause-timer-always")
                    ? (e.videoplaying = !0)
            ...
            if ("carousel" == e.sliderType)
                ...
                (h = new punchgs.TimelineLite({
                    ...
                    h.pause(),
                    1 == e.firststart &&
                        (punchgs.TweenLite.set(o, { autoAlpha: 0 }),
                        (e.firststart = 0)),
        ...
        M = function (n, o) {
            ...
            var s = function () {
                0 == e("body").find(n).length &&
                    (P(n, o), clearInterval(o.cdint)),
            ...
            r.data(
                ...
                r.data("opt", o),
                o.slideamount > 1 &&
                (0 != o.stopAfterLoops || 1 != o.stopAtSlide)
