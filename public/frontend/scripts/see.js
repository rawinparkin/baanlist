...
(function ($) {
	...
	/*--------------------------------------------------*/
        ...
        $(function () {
            $("#mobile-nav .menu-item-has-children > a").on(
                "click",
                function (ea) {
                    ea.preventDefault();
                }
	...
	/*----------------------------------------------------*/
        ...
        $(document).ready(function () {
            ...
            function checkWindowWidth() {
                ...
                if (windowWidth < 1024) {
                    $(".hws-wrapper .main-search-form").removeClass(
                        "gray-style"
                    );
                } else {
	...
	/*----------------------------------------------------*/
        ...
        $(document).on(
            ...
            function (e) {
                ...
                panelDropdowns.each(function () {
                    var panelDropdown = $(this);
                    var checkboxes = panelDropdown.find(
                        'input[type="checkbox"]'
                    );
	...
	/*--------------------------------------------------*/
        ...
        $('.range-slider-container:not(".no-to-disable")').toggleClass(
            "disabled"
        );
	...
	/*----------------------------------------------------*/
        ...
        var navListTop = document.querySelector(
    ...
    /*----------------------------------------------------*/
        ...
        $(window).on("load resize", function () {
            $(".full-page-map-container.map-fixed").addClass(
                "hide-map-on-mobile"
            );
...
/*--------------------------*/
        ...
        function initStickySidebar() {
            jQuery(document).ready(function ($) {
                ...
                if (!sidebar.length || !stickyWrapper.length || !content.length)
                    return; // Exit if elements don't exist

                // Only initialize if the outer height of .sticky-wrapper is greater than the sidebar's height
                if (stickyWrapper.outerHeight() <= sidebar.outerHeight())
                    return;
                ...
                $(window).on("scroll.stickySidebar", function () {
                    ...
                    var stickyOffset =
                        stickyWrapper.offset().top - scrollTop + 200; // Distance from top
                    var contentBottom =
                        content.offset().top + content.outerHeight(); // Bottom of content
    ...
    (i.prototype.init = function () {
        ...
        !0 !== e.initialized &&
            ...
            s.find("[data-submenu]").on("click", function (e) {
                ...
                o.length &&
                    ...
                    s.hasClass("submenu-opened") ||
                        s.addClass("submenu-opened"),
                    s[0].scrollTo({ top: 0 }),
                    i("opened", t));
            }),
            s.find("[data-submenu-close]").on("click", function (e) {
                ...
                o.length &&
                    ...
                    s.find(".submenu.opened").length ||
                        s.removeClass("submenu-opened"),
                    o[0].scrollTo({ top: 0 }),
                    i("closed", t));
            }),
            i("load"),
        ...
        (i.prototype.close = function (e) {
            e || this.eventController("closing", { subMenu: !1 }),
                ...
                this.options.htmlClass &&
                    l("html").removeClass("zeynep-opened"),
        ...
        (i.prototype.destroy = function () {
            this.eventController("destroying"),
                ...
                (this.options = n),
                this.options.htmlClass &&
                    l("html").removeClass("zeynep-initialized"),
                delete this.element,
                delete this.options,
