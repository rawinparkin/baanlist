    ...
    <div class="dashboard-content">
                ...
                <div class="col-md-12">
                    ...
                    <nav id="breadcrumbs">
                        <ul>
                            ...
                            <li><a href="{{ route('admin.dashboard') }}">ประกาศของฉัน</a></li>
                            <li>แก้ไขประกาศ</li>
                        </ul>
                    </nav>
                </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <form method="POST" action="{{ route('admin.update.property') }}" id="myForm"
                    ...
                    <div id="add-listing">
                        ...
                        <div class="add-listing-section">
                            ...
                            <div class="row with-forms">
                                ...
                                <div class="col-md-12 margin-top-10">
                                    <h5>หมดอายุ</h5>
                                    <input class="search-field" type="text" name="expire_date"
                                        value="{{ $property->expire_date }}" />
                                </div>
                        ...
                        <div class="add-listing-section margin-top-45">
                            ...
                            <div class="submit-section">
                                <div class="notification closeable notice">
                                    <p class="description" id="_gallery-description">โดยเลือก (คลิกที่รูปภาพ)
                                        ของรูปภาพที่อัปโหลด คุณจะตั้งให้เป็นรูปปกสำหรับประกาศนี้ (ทำเครื่องหมายโดย
                                        ไอคอนรูปดาว) ลากและวางภาพเพื่อจัดลำดับภาพใหม่ในแกลเลอรี</p>
                                </div>
                            ...
                            <div class="row with-forms margin-top-10">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="land_size" id="land_size"
                                        value="{{ $property->detail->land_size }}">
                                </div>
                        ...
                        <button id="close" class="button preview"
                            style="background:transparent; border: 1px solid #84c015; color:#84c015;">
