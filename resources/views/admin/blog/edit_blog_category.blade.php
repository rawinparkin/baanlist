            ...
            <div class="col-lg-6 col-md-12">
                <div class="dashboard-list-box margin-top-10">
                    ...
                    <div class="dashboard-list-box-static">
                        ...
                        <form id="typeForm" action="{{ route('blog.category.update') }}" method="POST"
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <a href="{{ route('all.blog.category') }}" class="button border margin-top-15">
