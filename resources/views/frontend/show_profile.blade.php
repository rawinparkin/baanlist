...
<meta property="og:image" content="{{ asset($property[0]->detail->cover_photo ?? 'frontend/images/banner.webp') }}" />
...
<meta name="twitter:image" content="{{ asset($property[0]->detail->cover_photo ?? 'frontend/images/banner.webp') }}" />
{!! $seo->adsense_headtag !!}
