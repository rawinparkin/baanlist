...
<title>{{$breadcat->category_name}} | baanlist</title>
...
<meta property="og:title" content="{{$breadcat->category_name}} | baanlist" />
...
<meta name="twitter:title" content="{{$breadcat->category_name}} | baanlist" />
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <h2>{{$breadcat->category_name}}</h2><span>ล่าสุด</span>
                                    ...
                                    <div class="widget-thumb">
                                        <a
                                            href="{{route('blog.details', ['id' => $item->id, 'slug' => $item->post_slug]) }}"><img
                                                src="{{asset($thumbnail2)}}" alt="{{$item->post_title}}" loading="lazy"></a>
                                    </div>
