        ...
        <div class="container">
            ...
            <div class="right-side">
                ...
                <div class="header-widget">
                    ...
                    <div class="user-menu">
                        <div class="user-name">
                            <span><img
                                    ...
                                    alt=""></span>สวัสดี {{ \Illuminate\Support\Str::limit(auth()->user()->name, 10) }}!</div>
                        <ul>
                    ...
                    <a href="#" class="button border with-icon" onclick="alert('กรุณาเข้าสู่ระบบก่อน'); return false;">ลงประกาศ<i
                            class="sl sl-icon-plus"></i></a>
