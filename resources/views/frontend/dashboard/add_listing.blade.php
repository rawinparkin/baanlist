                    ...
                    <div id="add-listing">
                        ...
                        <div class="add-listing-section">
                            ...
                            <div class="row with-forms">
                                <div class="col-md-12">
                                    <h5>ชื่อประกาศ<span style="color:red;"><b>*</b></span> <i class="tip"
                            ...
                            <div class="row with-forms">
                                ...
                                <!-- Keywords -->
                                <div class="col-md-6">
                                    <h5>จุดประสงค์<span style="color:red;"><b>*</b></span></h5>
                                ...
                                <!-- Category -->
                                <div class="col-md-6">
                                    <h5>ประเภท<span style="color:red;"><b>*</b></span></h5>
                            ...
                            <div class="submit-section">
                                ...
                                <div class="row with-forms">
                                    <div id="search-fields">
                                        <div class="col-md-12">
                                            <h5>ค้นหาตำแหน่ง จังหวัด, พื้นที่<span style="color:red;"><b>*</b></span></h5>
                        ...
                        <div class="add-listing-section margin-top-45">
                            ...
                            <!-- Headline -->
                            <div class="add-listing-headline">
                                <h3><i class="sl sl-icon-picture"></i> รูปภาพ<span style="color:red;"><b>*</b></span></h3>
                            </div>
                        ...
                        <div class="add-listing-section margin-top-45">
                            ...
                            <!-- Description -->
                            <div class="form">
                                <h5>คำบรรยาย<span style="color:red;"><b>*</b></span></h5>
                            ...
                            <div class="row with-forms margin-top-10">
                                ...
                                <!-- Land  -->
                                <div class="col-md-4">
                                    <h5>จำนวนพื้นที่ดิน<span style="color:red;"><b>*</b></span><span>(ตร.ม.)</span></h5>
                                    <input type="text" name="land_size" id="land_size" required>
                                </div>
                        ...
                        <button id="preview" class="button preview" type="submit" data-tip-content="กรุณากรอกข้อมูลให้ครบ" disabled >
                            ลงประกาศ
