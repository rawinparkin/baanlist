    ...
    public function Checkout($id)
    {
        ...
        if ($id == 1) {
            ...
            if ($user->credit == 0) {
                ...
                $validityDays = is_numeric($selectedPlan->validity_days) ? (int) $selectedPlan->validity_days : 0;
                UserPlan::create([
                    'user_id' => $user->id,
                    'package_id' => $id,
                    ...
                    'invoice' => $invoice,
                    'activated_at' => now(),
                    'expire_date' => now()->addDays($validityDays),
                ]);
            }
        ...
        try {
            ...
            if ($paymentMethod === 'card') {
                ...
                if ($paymentIntent->status === 'succeeded') {
                    ...
                    $validityDays = is_numeric($package->validity_days) ? (int) $package->validity_days : 0;
                    UserPlan::create([
                        'user_id' => $id,
